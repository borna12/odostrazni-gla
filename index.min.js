...
$(function() {
    function removeAccents(string) {
        const accents =
            "ÀÁÂÃÄÅàáȃâãäåāȁßÒÓÔÕÕÖØòóôõöøȏōȍÈÉÊËèéêëēȅÇçÐÌÍÎÏìíîïīȋȉÙÚÛÜùúûüūȕȗÑñŸÿýȑȓr̀r̂ŕr̄'’";
        const accentsOut =
            "AAAAAAaaaaaaaaaBOOOOOOOoooooooooEEEEeeeeeeCcDIIIIiiiiiiiUUUUuuuuuuuNnYyyrrrrrr  ";
        return string
            .split("")
            .map((letter, index) => {
