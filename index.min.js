...
$(function() {
    function removeAccents(string) {
        const accents =
            "ÀÁÂÃÄÅàáȃâãäåāȁßÒÓÔÕÕÖØòóôõöøȏōȍÈÉÊËèéêȇëēȅÇçÐÌÍÎÏìíîïīȋȉÙÚÛÜùúûüūȕȗÑñŸÿýȑȓr̀r̂ŕr̄'’";
        const accentsOut =
            "AAAAAAaaaaaaaaaBOOOOOOOoooooooooEEEEeeeeeeeCcDIIIIiiiiiiiUUUUuuuuuuuNnYyyrrrrrr  ";
        return string
            .split("")
            .map((letter, index) => {
                ...
                for (e = document.getElementById("filter").value.toUpperCase(), duljina = e.length, n = document.getElementById("JSONunorderedList").getElementsByTagName("li"), t = 0; t < n.length; t++)
                    for (y = 0; y < n[t].getElementsByTagName("div").length; y++) {
                        i = n[t].getElementsByTagName("div")[y],
                            rijec = removeAccents(i.innerHTML).toUpperCase().slice(-duljina)
                        if("" == e) {
    ...
    $(document).keydown(function(e) {
        ...
        e(), 0 == $("#JSONunorderedList").children(":visible").length ? $("#poruka").show() : $("#poruka").hide()
